...
contract VouchMe is ERC721URIStorage {
    ...
    function getTestimonialDetails(
        ...
        require(
            _testimonial[sender][receiver] == tokenId,
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    tokenId.toString(),
                    '","sender":"',
                    addressToString(testimonial.sender),
                    '","receiver":"',
                    addressToString(testimonial.receiver),
                    '","content":"',
                    testimonial.content,
                    '","giverName":"',
                    ...
                    '","timestamp":"',
                    uint256(testimonial.timestamp).toString(),
                    '","verified":"',
                    testimonial.verified ? "true" : "false",
                    '"}'
                )
            );
    }
     ...
     */
    function hasExistingTestimonial(
        address sender,
        address receiver
     ...
     */
    function _removeTestimonialFromList(
        uint256 tokenId,
        address sender,
        address receiver
    ) internal {
    ...
    function deleteTestimonial(uint256 tokenId) external {
        ...
        address sender = _testimonials[tokenId].sender;
        require(
            _testimonial[sender][msg.sender] == tokenId,
